...
<div class="cuar-address col-lg-6 col-md-12 cuar-<?php echo $address_class; ?>" data-address-id="<?php echo $address_id; ?>">
    ...
    <div class="panel">
        <div class="panel-heading"><?php
            ...
            if (!empty($address_actions)) :
                ?><span class="cuar-address-actions pull-right"><?php
                foreach ($address_actions as $action => $desc) {
                    ...
                    echo $desc['label'];
                    ?></a>&nbsp; <?php
                } ?></span><?php endif; ?><span class="cuar-progress" style="display: none;"><span class="indeterminate"></span></span></div>
