...
<div class="cuar-address cuar-<?php echo $address_class; ?>" data-address-id="<?php echo $address_id; ?>">
    ...
    <div class="form-group cuar-address-logo-url">
        ...
        <div class="cuar-upload-control">
            <input type="text" name="cuar_options[<?php echo $address_id; ?>][logo_url]" id="<?php echo $address_id; ?>_logo_url" value="<?php echo esc_attr($address['logo_url']); ?>" placeholder="<?php esc_attr_e('Logo URL', 'cuar'); ?>" class="regular-text cuar-address-field cuar-upload-input"/>
