...
<div class="cuar-payment-notes cuar-js-payment-notes-manager">
    <?php wp_nonce_field('cuar_add_note', 'cuar_add_note_nonce'); ?>
    <?php wp_nonce_field('cuar_remove_note', 'cuar_remove_note_nonce'); ?>
    ...
    <div class="cuar-payment-note cuar-js-add-note-form">
        ...
        <button class="button cuar-js-add-note"><?php _e('Add note', 'cuar'); ?></button>
    </div>

    <div class="cuar-payment-note" <?php if (!empty($notes)) : ?>style="display: none;"<?php endif; ?>>
