    ...
    class CUAR_Plugin
    {
        ...
        public function load_scripts()
        {
            ...
            if (is_admin()) {
                ...
                wp_register_script('cuar.frontend', CUAR_PLUGIN_URL . 'assets/frontend/js/customer-area.min.js', array('jquery', 'jquery-ui-core', 'jquery-ui-draggable', 'jquery-ui-droppable', 'jquery-ui-sortable', 'jquery-ui-mouse'), $this->get_version());
